...
export default class Department extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      DepartmentName: "",
      DepartmentId: 0,
      //below accepts filter inputs from user
      DepartmentIdFilter: "",
      DepartmentNameFilter: "",
      departmentsWithoutFilter: []  // stores dept data without filter
    }
    // this.changeDepartmentName = this.changeDepartmentName.bind(this); // old way of doing things
  }
  ...
  // takes prop name and a boolean to indicate whether t sort by ascending or descenfing
  sortResult(prop, asc) {
  ...
  updateClick() {
    fetch(variables.API_URL + 'department', {
      ...
      body: JSON.stringify({   // passing new departmentId as JSON in the method body
            ...
            {departments.map(d =>
              <tr key={d.DepartmentId}>
                ...
                <td>
                  ...
                  <button type="button"
                    className='btn btn-light mr-1'
                    onClick={() => this.deleteClick(d.DepartmentId)}>
